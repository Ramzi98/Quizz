...
import com.example.quizz.Controller.Activity.QuizzsGestion;
...
public class DOMQuizz {
    ...
    //Methode execute pour lancer l'execution
    public void execute() {
        httpTitle.execute() ;
    }

    //Class AsyncTask pour s'executer à l'arriere plan
    class HttpTitle  extends AsyncTask<Void, Void, List<String>> {
        //Déclaration des variable
        private List<String> titles = new ArrayList<>();
        ArrayList<com.example.quizz.Model.DataBase.Quizz> Quizz = new ArrayList<>();
        ...
        private void getPage(String adresseURL) {
            ...
            try {
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    //Si y'a des problemes de connexion on affiche un message d'erreur pour l'utilisateur
        ...
        protected List<String> doInBackground(Void... params) {
            //Spécification de l'url d'ou on veut récuprer les questions
        ...
        protected void onPostExecute(List<String> titles) {
            //Envoi des donnée vers l'activity QuizzGEstion pour les stocker dans la BDD
